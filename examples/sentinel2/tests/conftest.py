...
@pytest.fixture
def S2A_raster_files(tmpdir):
    dst_dir = tmpdir.join('S2A')
...
@pytest.fixture
def S2B_raster_files(tmpdir):
    dst_dir = tmpdir.join('S2B')
